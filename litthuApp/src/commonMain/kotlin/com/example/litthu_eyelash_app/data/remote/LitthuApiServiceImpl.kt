...
class LitthuApiServiceImpl(
    ...
    override suspend fun login(authRequest: AuthRequestDomainEntity): AuthResponseEntity {
        return client.post(LitthuApiConfig.Auth.AUTH004) {
            setBody(authRequest)
        }.body()
    }

    override suspend fun refreshToken(refreshToken: String): AuthResponseEntity {
        return client.post(LitthuApiConfig.Auth.AUTH005) {
